    ...
    <div>
      {years.map((year) => {
        ...
        days.forEach((day) => {
          ...
          if (dayOfWeek === 6) {
            // If it's Saturday, week is complete
        ...
        return (
          <div key={year} className="flex flex-col items-center space-y-8 p-4 sm:p-6 lg:p-8 bg-white rounded-lg shadow-md mb-6">
            <div
            ...
            >
              ...
              <div className="flex justify-center w-full overflow-x-auto">
                <div className="flex flex-col gap-1 mr-3 text-xs text-gray-500 justify-start">
                  {dayNames.map((day) => (
                    <div
                      key={day}
